...
namespace IRunes.App.Extensions
{
    public static class EntityExtension
    {
        ...
        {
            return album.Tracks.Count == 0 ? "There are currently no tracks available." : string.Join("", album.Tracks.Select((track, index) => track.ToHtmlAll(album.Id, index + 1)));
        }
            ...
            return  "<div class=\"album-details d-flex justify-content-between row\">" +
                        "<div class=\"album-data col-md-4\">" +
                            ...
                            $"<h1 class=\"text-center\">Album Price: ${album.Price}</h1>" +
                                ...
                                "</div>" +
                        "</div>" +
                        "<div class=\"album-tracks w-50 col-md-6\">" +
                            "<h1>Tracks</h1>" +
                                "<div>" +
                                    $"{GetTracks(album)}" +
                                "</div>" +
        ...
        public static string ToHtmlDetails(this Track track, string albumId)
        {
            return "<div class=\"track-details\">" +
                       ...
                       "<div class=\"d-flex justify-content-center\">" +
                           $"<iframe src=\"{WebUtility.UrlDecode(track.Link)}\" class=\"w-50 mx-auto\" height=\"480\"></iframe>" +
                       "</div>" +
                       "<hr class=\"bg-success w-50\" style=\"height: 2px\" />" +
                       "<div class=\"d-flex justify-content-center\">" +
